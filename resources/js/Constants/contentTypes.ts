...
export const CONTENT_TYPE_CONFIG = {
  ...
  poll: {
    ...
    fields: {
      title: {
        required: true,
        label: 'publications.modal.poll.question',
        placeholder: 'publications.modal.poll.questionPlaceholder',
      },
      description: {
        required: false,
        label: 'publications.modal.add.description',
      ...
      poll_options: {
        required: true,
        label: 'publications.modal.poll.options',
      },
      poll_duration_hours: {
        required: true,
        label: 'publications.modal.poll.duration',
      },
    },
  },
} as const;
...
export type Platform =
  | (typeof REEL_COMPATIBLE_PLATFORMS)[number]
  | 'facebook'
  | 'twitter'
  | 'linkedin'
  | 'pinterest';
...
export const isFieldRequired = (
  ...
  fieldName: keyof ContentTypeFieldsConfig,
): boolean => {
...
export const suggestContentTypeFromFiles = (
  files: File[],
