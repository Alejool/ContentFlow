                        ...
                        <div className="flex items-center">
                            <Dropdown>
                                ...
                                <Dropdown.Content>
                                    ...
                                    <Dropdown.Link href={route('logout')} method="post" as="button" className="flex items-center space-x-2 text-red-600">
                                        <span>🚪</span>
                    ...
                    <div className="px-4 py-6 space-y-2">
                        ...
                        <div className="pt-4 border-t border-gray-200/50">
                            <ResponsiveNavLink
                                ...
                                method="post"
                                as="button"
                                className="flex items-center space-x-3 px-4 py-3 rounded-2xl text-red-600 hover:bg-red-50 transition-all duration-300 w-full"
                            >
