...
interface UsePublicationTypeStateReturn {
  ...
  isValidForSave: (publication: Publication, typeState: TypeSpecificState) => { valid: boolean; errors: string[] };
  resetAllStates: () => void;
}
...
export const usePublicationTypeState = (): UsePublicationTypeStateReturn => {
  ...
  const stateByType = useRef<Record<ContentType, TypeSpecificState>>({
    post: { selectedPlatforms: [], platformSettings: {}, youtubeThumbnails: {} },
    reel: { selectedPlatforms: [], platformSettings: {}, youtubeThumbnails: {} },
    story: { selectedPlatforms: [], platformSettings: {}, youtubeThumbnails: {} },
    poll: { selectedPlatforms: [], platformSettings: {}, youtubeThumbnails: {} },
    carousel: { selectedPlatforms: [], platformSettings: {}, youtubeThumbnails: {} },
  });
  ...
  const clearIncompatibleData = useCallback((newType: ContentType, connectedAccounts: any[]) => {
  ...
  const isValidForSave = useCallback((publication: Publication, typeState: TypeSpecificState): { valid: boolean; errors: string[] } => {
    const errors: string[] = [];
