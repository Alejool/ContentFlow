...
import { useValidateVideo, type VideoValidationResult } from './usePlatformCapabilities';
...
export function usePublicationCapabilities(publicationId: number | null) {
  ...
  const [videoValidationResults, setVideoValidationResults] = useState<VideoValidationResult[] | null>(null);
    ...
    const fetchCapabilities = async () => {
      ...
      try {
        ...
        if (response.data.has_media) {
          ...
          const videoFile = publication.media_files?.find((m: any) => 
