        ...
        >
          ...
          <div className="border-b border-gray-200 px-6 py-4 dark:border-neutral-700">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                onClick={handleSkip}
                className="flex min-h-11 min-w-11 items-center justify-center rounded-md p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-neutral-700 dark:hover:text-gray-300"
      ...
      >
        ...
        <div className="border-b border-gray-200 px-6 py-4 dark:border-neutral-700">
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              onClick={handleSkip}
              className="flex min-h-11 min-w-11 items-center justify-center rounded-md p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:hover:bg-neutral-700 dark:hover:text-gray-300"
              aria-label={t('tour.close')}
            >
              <X size={20} />
            </button>
