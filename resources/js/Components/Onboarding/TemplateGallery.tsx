      ...
      <div className="flex max-h-[95vh] w-full max-w-6xl flex-col overflow-hidden rounded-xl bg-white shadow-2xl md:max-h-[90vh] dark:bg-neutral-800">
        ...
        <div className="border-b border-gray-200 bg-gray-50 px-4 py-3 md:px-6 md:py-4 dark:border-neutral-700 dark:bg-neutral-900">
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <div
              className="flex scrollbar-thin scrollbar-thumb-gray-300 gap-2 overflow-x-auto pb-2 sm:pb-0 dark:scrollbar-thumb-neutral-600"
              role="group"
        ...
        <div className="flex flex-col items-center justify-between gap-2 border-t border-gray-200 bg-gray-50 px-4 py-3 md:flex-row md:gap-0 md:px-6 md:py-4 dark:border-neutral-700 dark:bg-neutral-900">
          ...
          <button
            onClick={handleSkip}
            disabled={isSkipping}
            className="focus:ring-primary-500 min-h-[44px] w-full rounded-lg px-6 py-2 font-medium text-gray-600 transition-colors hover:text-gray-900 focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:w-auto dark:text-gray-400 dark:hover:text-white"
