    ...
    >
      <div className="relative flex h-8 w-8 items-center justify-center">
        ...
        <motion.div
          ...
          className={`absolute -bottom-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full border border-gray-200/40 bg-white/80 shadow-md backdrop-blur-sm transition-all duration-300 dark:border-neutral-600/40 dark:bg-theme-bg-secondary ${
