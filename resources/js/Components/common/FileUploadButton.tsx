...
export default function FileUploadButton({
  ...
  const variantStyles = {
    ...
    secondary:
      'border-2 border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-gray-700 focus:ring-gray-500',
    ghost:
      'border-2 border-transparent bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-gray-700 focus:ring-gray-500',
  };
