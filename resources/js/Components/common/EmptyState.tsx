      ...
      <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
        ...
        {config.secondaryActions?.map((action, index) => (
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 font-medium text-gray-700 transition-colors duration-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-gray-700 dark:focus:ring-offset-gray-900"
