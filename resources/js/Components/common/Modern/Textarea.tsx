...
export default function Textarea<T extends FieldValues>({
  ...
  const sizeConfig = {
    sm: { textarea: "py-2 text-xs", icon: "w-4 h-4", label: "text-xs" },
    md: { textarea: "py-3 text-sm", icon: "w-5 h-5", label: "text-sm" },
    lg: { textarea: "py-4 text-base", icon: "w-6 h-6", label: "text-base" },
  };
