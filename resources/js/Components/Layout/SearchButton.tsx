...
export default function SearchButton({ className = '', variant = 'default' }: SearchButtonProps) {
  ...
  if (variant === 'compact') {
    return (
      <button
        onClick={handleClick}
        className={`rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:text-neutral-400 dark:hover:bg-neutral-800 dark:hover:text-gray-200 ${className}`}
