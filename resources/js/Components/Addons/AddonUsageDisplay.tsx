  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        <span className="text-sm text-gray-500">{formatValue(currentUsage)} usado</span>
      </div>
      ...
      {(addonTotal > 0 || isExceedingPlan) && (
        <div className="border-t pt-4">
          <div className="mb-2 flex items-center justify-between">
            <span className="text-sm font-medium text-orange-700">Addons de Extensión</span>
            <span className="text-sm text-orange-600">{formatValue(addonTotal)} disponible</span>
          </div>
          ...
          <div className="mt-1 flex justify-between text-xs text-orange-600">
      ...
      {/* Total Usage Summary */}
      <div className="-mx-6 -mb-6 mt-4 rounded-b-lg border-t bg-gray-50 px-6 pb-6 pt-4">
