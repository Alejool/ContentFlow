...
export function AddonsInfoBanner() {
  ...
  return (
    <div className="border-primary-200 from-primary-50 to-primary-100 dark:border-primary-700/50 dark:from-primary-900/20 dark:to-primary-800/20 rounded-xl border bg-gradient-to-br p-6">
