...
export function ExtensionAddonsInfoBanner() {
  ...
  return (
    <div className="rounded-lg border border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-100 p-6 dark:border-blue-700/50 dark:from-blue-900/20 dark:to-indigo-800/20">
