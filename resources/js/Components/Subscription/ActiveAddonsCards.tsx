...
export function ActiveAddonsCards({
  showCarousel = true,
}: ActiveAddonsCardsProps) {
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            ...
            {t(
              "subscription.addons.additionalPackages",
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            ...
            {addons.length === 1
              ...
              : t(
                  "subscription.addons.activeAddonsPlural",
                  "paquetes activos",
                )}{" "}
            •
            <span className="font-semibold text-primary-600 dark:text-primary-400 ml-1">
              ${totalSpent.toFixed(2)}{" "}
              {t("subscription.addons.totalSpent", "Total Gastado")}
            </span>
            {addons.length > 0 && (
