      ...
      {isOpen && (
        <Dialog as="div" className="relative z-50" onClose={setIsOpen} open={isOpen}>
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto p-4 sm:p-20">
            ...
            >
              <DialogPanel className="transform divide-y divide-gray-100 overflow-hidden rounded-lg bg-white shadow-2xl ring-1 ring-black/5 dark:divide-neutral-800 dark:bg-neutral-900">
                <Combobox
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <ComboboxInput
                      ref={inputRef}
                      className="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-gray-900 placeholder:text-gray-400 focus:ring-0 dark:text-neutral-100 sm:text-sm"
                    ...
                    >
                      {Object.entries(groupedCommands).map(([category, items]) => (
                        <div key={category} className="mb-2">
                          {/* Category Label */}
                          <div className="px-3 py-2 text-xs font-semibold text-gray-500 dark:text-neutral-400">
                  ...
                  {/* Footer */}
                  <div className="flex flex-wrap items-center bg-gray-50 px-4 py-2.5 text-xs text-gray-500 dark:bg-neutral-800/50 dark:text-neutral-400">
                    <kbd className="flex items-center gap-1 rounded border border-gray-200 bg-white px-1.5 py-0.5 font-mono shadow-sm dark:border-neutral-600 dark:bg-neutral-700">
                      <span className="text-xs">⌘</span> K
                    </kbd>
                    <span className="ml-2">para abrir/cerrar</span>
                    <span className="mx-2">·</span>
                    <kbd className="rounded border border-gray-200 bg-white px-1.5 py-0.5 font-mono shadow-sm dark:border-neutral-600 dark:bg-neutral-700">
                      ↑↓
                    </kbd>
