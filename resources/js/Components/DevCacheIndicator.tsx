...
export function DevCacheIndicator() {
  ...
  const isUsingDatabase = 
    cacheInfo.cache_driver === 'database' || 
    cacheInfo.queue_driver === 'database';
      ...
      <div className="rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 px-4 py-2 dark:border-gray-700">
          <div className="flex items-center gap-2">
            <div className={`${getColor(cacheInfo.cache_driver)} h-2 w-2 rounded-full animate-pulse`} />
            ...
            <div className="mt-3 rounded-md bg-yellow-50 p-3 dark:bg-yellow-900/20">
              <div className="flex items-start gap-2">
                ...
                <div className="text-xs text-yellow-800 dark:text-yellow-200">
                  ...
                  <p className="mt-1">
                    Usando database cache. Performance reducida 5-10x.
                  </p>
                </div>
              </div>
            </div>
