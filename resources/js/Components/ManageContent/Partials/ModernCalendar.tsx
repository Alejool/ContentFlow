          ...
          <div className="flex items-center gap-4">
            <div className="relative month-picker-container">
              <Button
                ...
                size="lg"
                icon={ChevronDown}
                className="font-bold text-gray-900 dark:text-white capitalize flex items-center gap-3 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
              >
            ...
            <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg p-1 overflow-x-auto scrollbar-subtle max-w-full sm:max-w-none">
              {platforms.map((p) => (
                <Button
                  ...
                  variant="ghost"
                  size="lg"
                  className={`p-3 ${platformFilter === p ? " border-none bg-white dark:bg-gray-700 shadow text-primary-600" : "text-gray-400 hover:text-gray-600"}`}
                  title={
                    p === "all"
