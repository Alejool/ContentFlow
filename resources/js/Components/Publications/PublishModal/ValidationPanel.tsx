...
export default function ValidationPanel({
  ...
  const hasWarnings = validationResult.global_warnings && validationResult.global_warnings.length > 0;
      ...
      {validationResult.platform_results && (
        <div className="mb-4">
          ...
          <div className="space-y-2">
            {Object.entries(validationResult.platform_results).map(([platform, result]: [string, any]) => (
              <div
                key={platform}
