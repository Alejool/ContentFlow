export default function MediaUploadSkeleton() {
  return (
    <div className="animate-pulse space-y-4">
      ...
      <div className="flex min-h-5 items-center justify-center rounded-lg border-2 border-dashed border-gray-200 bg-gray-50 dark:border-neutral-600 dark:bg-neutral-700">
