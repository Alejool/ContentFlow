    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-3">
            ...
            {availableTypes.map((type) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    isAvailable && !isTypeLocked && onChange(type.value)
                  }
          ...
          {selectedPlatforms.length > 0 &&
            availableTypes.length < contentTypes.length && (
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                <p className="font-medium text-gray-700 dark:text-gray-300 mb-1">
                  {t("publications.modal.contentType.mediaAllowed") ||
                    "Media Allowed:"}
                </p>
                      ...
                      <>
                        {selectedTypeDetails.mediaRules.maxImages &&
                          selectedTypeDetails.mediaRules.maxImages > 0 && (
                            <li>
                              • Hasta {selectedTypeDetails.mediaRules.maxImages}{" "}
                              imagen
                              {selectedTypeDetails.mediaRules.maxImages > 1
                                ? "es"
                                : ""}
                            </li>
                          )}
                        {selectedTypeDetails.mediaRules.maxVideos &&
                          selectedTypeDetails.mediaRules.maxVideos > 0 && (
                            <li>
                              • Hasta {selectedTypeDetails.mediaRules.maxVideos}{" "}
                              video
                              {selectedTypeDetails.mediaRules.maxVideos > 1
                                ? "s"
                                : ""}
                            </li>
                          )}
              ...
              <div>
                <p className="font-medium text-gray-700 dark:text-gray-300 mb-1">
                  {t("publications.modal.contentType.platforms") ||
                    "Platforms:"}
                </p>
              ...
              {selectedType === "reel" && (
                <div className="pt-2 border-t border-gray-200 dark:border-neutral-700">
                  <p className="text-xs text-gray-500 dark:text-gray-400 italic">
                    💡 Los Reels/Shorts deben ser videos verticales (9:16) de
                    corta duración
                  </p>
                </div>
              )}
              ...
              {selectedType === "poll" && (
                <div className="pt-2 border-t border-gray-200 dark:border-neutral-700">
                  <p className="text-xs text-gray-500 dark:text-gray-400 italic">
                    💡 Las encuestas permiten interacción directa con tu
                    audiencia
                  </p>
                </div>
              )}
