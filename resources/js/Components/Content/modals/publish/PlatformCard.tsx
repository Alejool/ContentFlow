...
const PlatformCard = memo(({
  ...
  const canToggle = !isPublished && !isScheduled && !isPublishing && !isRetrying && !isDuplicate && !isDuplicateAttempt;
    ...
    <div className="relative w-full">
      ...
      >
        ...
        {!isPublishing && !isUnpublishing && !isPublished && (() => {
          ...
          const video = mediaFiles.find((m: any) => m.file_type === 'video' || m.mime_type?.startsWith('video/'));
      ...
      {isScheduled && !isPublishing && !isUnpublishing && (
        <div className="absolute -top-3 right-2 z-40">
          <div className="flex flex-col items-end gap-1">
            ...
            {(() => {
              const schedPost = publication.scheduled_posts?.find((sp: any) => sp.social_account_id === account.id);
      ...
      {publication && RecurringPostsSection && getRecurringPosts && getPublishedRecurringPosts && (
        <RecurringPostsSection
