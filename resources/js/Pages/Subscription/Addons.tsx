...
export default function Addons({ addons }: Props) {
    ...
    useEffect(() => {
        ...
        if (params.get('success') === 'true') {
            setNotification({
                type: 'success',
                message: t('subscription.addons.purchaseSuccess', '¡Compra exitosa! Tu addon se activará en unos momentos.'),
            });
            // Limpiar URL
            ...
            setNotification({
                type: 'error',
                message: t('subscription.addons.purchaseCanceled', 'Compra cancelada. No se realizó ningún cargo.'),
            });
            // Limpiar URL
            window.history.replaceState({}, '', window.location.pathname);
            ...
            setNotification({
                type: 'info',
                message: t('subscription.addons.purchasePending', 'Pago pendiente. Te notificaremos cuando se confirme.'),
            });
            // Limpiar URL
            window.history.replaceState({}, '', window.location.pathname);
        }
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            {t('subscription.addons.subtitle', 'Extiende tu capacidad con créditos de IA, almacenamiento, publicaciones y miembros del equipo')}
                        </p>
                    </div>
                    ...
                    {addons && Object.values(addons).some((category: any) => 
                        category.packages && Object.values(category.packages).some((pkg: any) => 
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
                                        {t('subscription.addons.currencyBanner.description', 
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300">
                                            ✓ {t('subscription.addons.currencyBanner.transparent', 'Precios transparentes')}
                                        </span>
                                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300">
