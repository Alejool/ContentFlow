                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-primary-900 dark:text-primary-300">
                          {t('approvals.locked.title') || 'Flujos de aprobaci├│n multi-nivel'}
                        </p>
                        <p className="mt-1 max-w-2xl text-xs leading-relaxed text-primary-700 dark:text-primary-400">
                          {t('approvals.locked.description') ||
                            'Tu plan actual permite aprobaciones de un nivel. Mejora tu plan para crear flujos de aprobaci├│n avanzados y multi-nivel con responsables jer├írquicos.'}
                        </p>
                      </div>
                    </div>
                    <Button
