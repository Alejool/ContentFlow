...
const posts = [
    {
        ...
        image: 'https://www.elegantthemes.com/blog/wp-content/uploads/2021/02/social-media-books-featured-image.jpg',
...
function ContentCard({ post }) {
    return (
        <div className="overflow-hidden bg-white rounded-lg shadow-md hover:bg-gray-50 transition duration-300 p-4">
            <img src={post.image} alt="Content Thumbnail" className="w-full h-40 object-cover rounded-md" />
            <div className="mt-4">
                <h3 className="text-lg font-semibold text-gray-800">{post.title}</h3>
                <p className="mt-2 text-sm text-gray-600">{post.description}</p>
                <p className="mt-2 text-sm text-gray-500">📅 Published: {post.date} on {post.platform}</p>
                <p className="mt-2 text-sm text-green-600">📊 Engagement: {post.engagement} ({post.growth})</p>
            </div>
        </div>
    );
}
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="mt-2 text-lg text-gray-600">Track and optimize your content strategy across social platforms.</p>
                    </div>
