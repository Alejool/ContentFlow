                            ...
                            {/* <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        <div className=" -bottom-16 -left-16 h-40 w-[calc(100%+8rem)] bg-gradient-to-b from-transparent via-white to-white dark:via-zinc-900 dark:to-zinc-900"></div>
                                    </div>
                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                    ...
                                    <div className="flex items-center gap-6 lg:items-end">
                                        <div className="flex items-start gap-6 lg:flex-col">
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                ...
                                                <p className="mt-4 text-sm/relaxed">
                                                    Create and manage your personal photo collections. Organize your memories
                                                    by albums, dates, or custom categories. Easy drag-and-drop interface
                                                    for seamless organization and management of your precious moments.
                                                </p>
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Powerful yet intuitive photo editing tools at your fingertips. 
                                            Adjust colors, apply filters, crop, resize, and enhance your photos
                                            with professional-grade editing features.
                                        </p>
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Transform your photo collections into stunning video slideshows.
                                            Add music, transitions, and effects to create memorable video
                                            presentations of your favorite moments.
                                        </p>
                                    </div>
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Explore advanced features like AI-powered photo enhancement,
                                            facial recognition for easy tagging, automatic background removal,
                                            and secure cloud backup. Share your collections with friends and
                                            family while maintaining full control over privacy settings.
                                        </p>
                                    </div>
                                </div>
                            </div>
