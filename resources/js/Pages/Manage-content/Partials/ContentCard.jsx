    ...
    return (
        ...
        >
            ...
            <div className="relative h-48 overflow-hidden">
                ...
                <div className={`absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center space-x-3 transition-opacity duration-300 ${isHovered ? 'opacity-100' : 'opacity-0'}`}>
                    <button
                        onClick={onEdit}
            ...
            <div className="p-6">
                ...
                <div className="mb-4">
                    <div className="flex flex-wrap gap-2">
                        {content.hashtags?.split(' ').slice(0, 3).map((tag, index) => (
                            <span 
                                key={index}
