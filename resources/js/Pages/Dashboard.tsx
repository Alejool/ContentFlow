...
import { Eye, MousePointerClick, TrendingUp, Users, Heart, ArrowRight } from 'lucide-react';
        ...
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                    ...
                    {stats.engagementTrends.length > 0 && (
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <LineChart
                                ...
                                lines={[
                                    { dataKey: 'views', name: t('dashboard.views'), color: '#3b82f6' },
                                    { dataKey: 'clicks', name: t('dashboard.clicks'), color: '#10b981' },
                                    { dataKey: 'engagement', name: t('dashboard.engagement'), color: '#8b5cf6' },
                                ]}
                                xAxisKey="date"
                                height={300}
                            />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        <h3 className="text-lg font-semibold mb-2">{t('dashboard.quickActions.campaigns.title')}</h3>
                    ...
                    >
                        <h3 className="text-lg font-semibold mb-2">{t('dashboard.quickActions.analytics.title')}</h3>
                    ...
                    >
                        <h3 className="text-lg font-semibold mb-2">{t('dashboard.quickActions.content.title')}</h3>
