        ...
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    />
                    <StatCard
                        title="Tasa de Engagement Promedio"
                    ...
                    {stats.engagementTrends.length > 0 && (
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <LineChart
                                ...
                                lines={[
                                    { dataKey: 'views', name: 'Vistas', color: '#3b82f6' },
                                    { dataKey: 'clicks', name: 'Clicks', color: '#10b981' },
                                    { dataKey: 'engagement', name: 'Engagement', color: '#8b5cf6' },
                                ]}
                                xAxisKey="date"
                                height={300}
                            />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        <h3 className="text-lg font-semibold mb-2">Campañas</h3>
                    ...
                    >
                        ...
                        <p className="text-green-100 text-sm">
                            Gestionar medios y publicaciones
                        </p>
                    </Link>
                </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-12 text-center mt-8">
                        <div className="max-w-md mx-auto">
                            ...
                            <p className="text-gray-600 mb-6">
                                Ejecuta el comando para generar datos de prueba:
                            </p>
                            <code className="bg-gray-100 px-4 py-2 rounded text-sm">
                                php artisan statistics:seed
                            </code>
                        </div>
                    </div>
                )}
