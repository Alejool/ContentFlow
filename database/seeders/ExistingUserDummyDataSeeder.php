...
class ExistingUserDummyDataSeeder extends Seeder
{
  ...
  private function createPublicationsAndAnalytics($user, $workspaceId)
  {
    ...
    $publicationTemplates = [
      [
        ...
        'hashtags' => ['verano2026', 'rebajas', 'moda', 'descuentos', 'shopping', 'estiloVerano', 'playaStyle', 'ofertas'],
      ...
      [
        ...
        'hashtags' => ['invierno', 'moda', 'nuevaColeccion', 'estiloInvernal', 'cozy', 'modaInvierno', 'nuevosDisenos', 'tendencias'],
      ...
      [
        ...
        'hashtags' => ['tecnologia', 'gadgets', 'tech', 'innovacion', 'vidaInteligente', 'electronica', 'ofertasTech', 'geek', 'smartHome'],
      ...
      [
        ...
        'hashtags' => ['organico', 'comidaSana', 'wellness', 'sostenible', 'comerLimpio', 'alimentacionOrganica', 'vidaSaludable', 'nutricion', 'ecoFriendly'],
      ...
      [
        ...
        'hashtags' => ['fitness', 'workout', 'desafio', 'transformacion', 'salud', 'motivacionFitness', 'gym', 'vidaSaludable', 'entrenamientoPersonal'],
      ...
      [
        ...
        'hashtags' => ['blackFriday', 'ofertas', 'descuentos', 'shopping', 'rebajas', 'blackFriday2026', 'megaOfertas', 'ahorros', 'comprasOnline'],
      ...
      [
        ...
        'hashtags' => ['anoNuevo', 'propositos', 'metas', 'motivacion', 'nuevoComienzo', 'anoNuevo2026', 'superacionPersonal', 'cambio', 'exito'],
      ...
      [
        ...
        'hashtags' => ['modaSostenible', 'ecoFriendly', 'fashionSostenible', 'etico', 'verde', 'slowFashion', 'consciente', 'ceroResiduos', 'modaEtica'],
      ...
      [
        ...
        'hashtags' => ['webinar', 'marketingDigital', 'capacitacion', 'emprendimiento', 'negocios', 'estrategias', 'educacion', 'gratis', 'marketing2026'],
      ...
      [
        ...
        'hashtags' => ['appMovil', 'productividad', 'tecnologia', 'organizacion', 'eficiencia', 'gestionTareas', 'innovacion', 'startup', 'lanzamiento'],
      ...
      [
        ...
        'hashtags' => ['fotografia', 'cursoOnline', 'fotografiaProfesional', 'aprenderFotografia', 'educacion', 'cursoDeFotografia', 'fotografo', 'capacitacion'],
      ...
      [
        ...
        'hashtags' => ['concurso', 'sorteo', 'ganaViaje', 'Paris', 'viajeGratis', 'giveaway', 'premio', 'participa', 'suerte'],
      ...
      [
        ...
        'hashtags' => ['podcast', 'emprendimiento', 'negocios', 'exito', 'startups', 'motivacion', 'empresarios', 'inspiracion', 'liderazgo'],
      ...
      [
        ...
        'hashtags' => ['inversiones', 'finanzas', 'masterclass', 'dinero', 'bolsa', 'trading', 'ahorro', 'libertadFinanciera', 'educacionFinanciera'],
      ...
      [
        ...
        'hashtags' => ['libro', 'redesSociales', 'marketing', 'emprendimiento', 'contenido', 'socialmedia', 'negociosOnline', 'lanzamiento', 'bestseller'],
      ...
      [
        ...
        'hashtags' => ['networking', 'evento', 'emprendedores', 'negocios', 'conexiones', 'startups', 'empresarios', 'oportunidades', 'comunidad'],
      ...
      [
        ...
        'hashtags' => ['transformacionDigital', 'consultoria', 'digitalizacion', 'tecnologia', 'innovacion', 'negocios', 'empresas', 'automatizacion', 'crecimiento'],
      ...
      [
        ...
        'hashtags' => ['afiliados', 'ingresoPasivo', 'ganarDinero', 'marketingAfiliados', 'negocios', 'trabajarDesdeCasa', 'emprendimiento', 'libertadFinanciera', 'comisiones'],
      ...
      [
        ...
        'hashtags' => ['bootcamp', 'programacion', 'desarrolloWeb', 'fullstack', 'coding', 'tecnologia', 'carrera', 'aprender', 'javascript'],
      ...
      [
        ...
        'hashtags' => ['membresia', 'comunidad', 'emprendedores', 'networking', 'mentoria', 'negocios', 'crecimiento', 'exclusivo', 'premium'],
  ...
  private function createSocialAccountsAndMetrics($user, $workspaceId)
  {
    ...
    $platforms = [
      ...
      ['name' => 'linkedin', 'account_name' => 'Mi Empresa LinkedIn', 'followers_base' => rand(1000, 20000)],
    ...
    while ($currentDate <= Carbon::now()) {
      ...
      if (!$exists) {
        ...
        $growthRate = match($account->platform) {
          ...
          'linkedin' => rand(5, 40),      // LinkedIn crecimiento profesional
          default => rand(0, 50),
        };
        ...
        $postsPerDay = match($account->platform) {
          ...
          'linkedin' => $isWeekend ? rand(0, 1) : rand(0, 2),
        ...
        $engagementRate = match($account->platform) {
          ...
          'linkedin' => rand(2, 6),     // LinkedIn engagement profesional
          default => rand(1, 5),
        };
