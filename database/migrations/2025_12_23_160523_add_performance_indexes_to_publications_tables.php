...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $this->addIndexIfMissing('scheduled_posts', ['publication_id', 'status'], 'idx_publication_status');
        $this->addIndexIfMissing('scheduled_posts', 'social_account_id', 'idx_social_account');
        $this->addIndexIfMissing('social_post_logs', ['publication_id', 'status'], 'idx_publication_status');
        $this->addIndexIfMissing('social_post_logs', 'social_account_id', 'idx_social_account');
    ...
    private function addIndexIfMissing(string $table, $columns, string $indexName): void
    {
        ...
        // This approach is database-agnostic for checking index existence,
        // but the SHOW INDEX FROM syntax is MySQL specific.
        // For other databases, you might need to adjust this check.
    ...
    public function down(): void
    {
        ...
        Schema::table('scheduled_posts', function (Blueprint $table) {
            $table->dropIndex('idx_publication_status');
            $table->dropIndex('idx_social_account');
        });
