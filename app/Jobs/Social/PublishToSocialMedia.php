...
use App\Notifications\Publication\PublicationPublishedNotification;
use App\Notifications\Publication\PublicationPostFailedNotification;
      ...
      try {
        if ($publication->workspace) {
          $publication->workspace->notify(
            new \App\Notifications\Publication\PublicationResultNotification($log, 'failed', $log->error_message)
          );
        }
      } catch (\Exception $e) {
